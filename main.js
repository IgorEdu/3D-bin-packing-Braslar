...
import img1 from './textures/ground/Concrete_019_BaseColor.jpg?url';
import img2 from './textures/ground/Concrete_019_Normal.jpg?url';
import img3 from './textures/ground/Concrete_019_Height.png?url';
import img4 from './textures/ground/Concrete_019_Roughness.jpg?url';
import img5 from './textures/ground/Concrete_019_AmbientOcclusion.jpg?url';

import model1 from './models/lift_truck/scene.glb?url';
import model2 from './models/pallet_truck/scene.glb?url';
import model3 from './models/truck/truck-wheels.gltf?url';
import model4 from './models/truck/truck-support.gltf?url';
...
async function appLoader() {
    ...
    const lift_truck_model = await modelLoader(model1);
    const pallet_truck_model = await modelLoader(model2);
    const truck_wheels_model = await modelLoader(model3);
    const truck_support_model = await modelLoader(model4);
...
function loadFloor() {
    ...
    const groundBaseColor = textureLoader.load(img1);
    const groundNormalMap = textureLoader.load(img2);
    const groundHeightMap = textureLoader.load(img3);
    const groundRoughnessMap = textureLoader.load(img4);
    const groundAmbientOcclusion = textureLoader.load(img5);
